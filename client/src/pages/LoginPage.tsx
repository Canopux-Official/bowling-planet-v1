...
const LoginPage: FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log(`Login submitted for ${role}:`, form)
  }
  ...
  const inputStyle = (isFocused: boolean) => ({
    ...
    boxShadow: isFocused ? `0 0 0 3px rgba(95,193,209,0.2)` : 'inset 0 2px 4px rgba(0,0,0,0.5)',
  })
  ...
  return (
    <div style={{ background: theme.colors.void, minHeight: '100vh', display: 'flex' }}>
      ...
      <div className="auth-brand-side" style={{
        ...
        {/* Brand Logo - Top Left (Matching Nav) */}
        ...
        <div className="orb orb-teal" style={{ width: 800, height: 800, top: '-10%', left: '-20%', opacity: 0.25 }} />
        <div className="orb orb-green" style={{ width: 600, height: 600, bottom: '-10%', right: '-10%', opacity: 0.2 }} />
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 480 }}>
          <div style={{ 
            ...
            fontSize: 12, fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: 24, border: `1px solid rgba(95,193,209,0.3)`
          }}>
            Admin Portal Login
          </div>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border: 'none',
                background: role === 'superadmin' ? 'rgba(255,255,255,0.1)' : 'transparent',
                color: role === 'superadmin' ? theme.colors.text1 : theme.colors.text2,
                fontSize: 14,
                fontWeight: 600,
                cursor: 'pointer',
                transition: 'all 0.3s ease',
            ...
            <button
              ...
              style={{
                ...
                color: role === 'admin' ? theme.colors.text1 : theme.colors.text2,
                fontSize: 14,
                fontWeight: 600,
                cursor: 'pointer',
                transition: 'all 0.3s ease',
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 20 }}>
              ...
              <input
                type="email"
                required
                placeholder="admin@bowlingplanet.in"
                value={form.email}
            ...
            <button type="submit" style={{ 
              ...
              boxShadow: `0 10px 20px rgba(95,193,209,0.2), inset 0 1px 0 rgba(255,255,255,0.4)`
            }}
