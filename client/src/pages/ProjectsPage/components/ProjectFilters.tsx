...
const pillClass = (active: boolean) =>
  `shrink-0 cursor-pointer rounded-full border px-4 py-2 text-sm font-semibold backdrop-blur-md transition-colors ${
    active
      ? 'border-[#5FC1D1] bg-[#5FC1D1]/20 text-[#5FC1D1]'
      : 'border-white/15 bg-[#111118]/80 text-[#A1A1A6] hover:border-[#5FC1D1]/40 hover:text-[#F5F5F7]'
  }`
    ...
    <div className="mb-6 space-y-4">
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full rounded-xl border border-white/[0.12] bg-[#111118]/85 py-2.5 pl-10 pr-4 text-sm text-[#F5F5F7] outline-none backdrop-blur-md transition-colors placeholder:text-[#48484A] focus:border-[#5FC1D1]/50"
        />
      </div>
