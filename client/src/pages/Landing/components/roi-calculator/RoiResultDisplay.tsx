...
//   return (
//     <div style={{ display: 'flex', alignItems: 'flex-end', gap: 12, height: 160, paddingBottom: 8, paddingTop: 16 }}>
...
//  */
// function MetricCard({ icon: Icon, label, value, subtext, color }: { icon: React.ReactNode; label: string; value: string; subtext?: string; color: string }) {
//   return (
//     <div
//       style={{
...
//       }}
//     >
//       <div style={{ width: 44, height: 44, borderRadius: 10, background: `${color}12`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, color: color }}>
//         {Icon}
//       </div>
//       <div>
...
//           {label}
//         </div>
//         <div className="font-display" style={{ fontSize: 22, fontWeight: 800, color: theme.colors.text1, letterSpacing: '-0.01em' }}>
//           {value}
//         </div>
//         {subtext && (
...
//       {/* Dynamic 2-Column Responsive Layout Split */}
//       <div
//         style={{
//           display: 'grid',
...
//         {/* LEFT COLUMN: Visual Summary & Performance Charts */}
//         <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>

//           {/* Main Title Badge */}
//           <div style={{ borderBottom: `1px solid ${theme.colors.border}40`, paddingBottom: 24 }}>
//             <span style={{
//               display: 'inline-flex',
//               padding: '6px 12px',
//               borderRadius: 20,
...
//         {/* RIGHT COLUMN: Structural Financial Breakdowns */}
//         <div style={{ display: 'flex', flexDirection: 'column', gap: 32, background: 'rgba(255,255,255,0.01)', borderLeft: `1px solid ${theme.colors.border}40`, paddingLeft: 40 }}>

//           <div>
//             <h4 className="font-display" style={{ fontSize: 14, fontWeight: 700, color: theme.colors.text1, marginBottom: 16, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
