  ...
  processSteps: [
    {
      ...
      image: { url: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' },
    },
    {
      num: '02',
      title: 'Strategy',
      desc: 'ROI modelling, layout design, and game selection blueprint.',
      image: { url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' },
    },
    {
      num: '03',
      title: 'Execution',
      desc: 'Setup, staff training, vendor coordination, and soft launch.',
      image: { url: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' },
    },
    {
      num: '04',
      title: 'Growth',
      desc: 'Ongoing ops management, analytics, and performance tuning.',
      image: { url: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' },
    },
  ],
  galleryImages: [
    { image: { url: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' }, label: 'Arcade Zone' },
    { image: { url: 'https://images.unsplash.com/photo-1560264280-88b68371db39?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' }, label: 'Hospitality' },
    { image: { url: 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' }, label: 'Center Design' },
    { image: { url: 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' }, label: 'Operations Hub' },
    { image: { url: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' }, label: 'Marketing' },
    { image: { url: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=800&auto=format&fit=crop', public_id: 'dummy' }, label: 'Team Synergy' },
  ],
  results: [
